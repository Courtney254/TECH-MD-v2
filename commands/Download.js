                ...
                await sock.sendMessage(chatId, {
                    ...
                    contextInfo: {
                        ...
                        forwardedNewsletterMessageInfo: {
                            newsletterJid: '120363420444726664@newsletter',
                            newsletterName: 'TECH-MD',
                            serverMessageId: -1
                        }
                    }
                });
    ...
    try {
      ...
      if (data.status && data.BK9 && data.BK9.high) {
        await sock.sendMessage(chatId, {
          ...
          caption: "🎥 *TECH-MD* Video Downloader (High Quality)",
          contextInfo: {
            forwardingScore: 1,
            isForwarded: true,
            forwardedNewsletterMessageInfo: {
...
}, 
{
  ...
  execute: async (sock, msg, args) => {
    ...
    try {
      ...
      const caption = `*🔞 THE TECH-MD X-Video Downloader 🥵*\n\n` +
      ...
      if (data.status && data.result && data.result.length > 0) {
        ...
        if (url.startsWith('https://www.instagram.com/reel/')) {
          if (media.url) {
            await sock.sendMessage(chatId, {
              video: { url: media.url },
              caption: "TECH-MD INSTA DOWNLOADER - Video",
              contextInfo
            }, { quoted: msg });
          ...
          if (media.thumbnail) {
            await sock.sendMessage(chatId, {
              ...
              caption: "TECH-MD INSTA DOWNLOADER - Image",
              contextInfo
            }, { quoted: msg });
    ...
    try {
      getFBInfo(queryURL)
        .then(async (result) => {
          ...
          await sock.sendMessage(chatId, {
            video: { url: result.hd },
            caption: "_╰►FB VIDEO DOWNLOADED BY_ *TECH-MD*",
            contextInfo
          }, { quoted: msg });
        })
        .catch(async () => {
    ...
    try {
      getFBInfo(queryURL)
        .then(async (result) => {
          ...
          await sock.sendMessage(chatId, {
            video: { url: result.sd },
            caption: "_╰►FACEBOOK VIDEO DOWNLOADED BY_ *TECH-MD*",
            contextInfo
          }, { quoted: msg });
        })
        .catch(async (error) => {
      ...
      await sock.sendMessage(chatId, {
        text: "An error occurred while TECH-MD was downloading your media."
      }, { quoted: msg });
    }
  }
}, 
  ...
  execute: async (sock, msg, args) => {
    ...
    try {
      ...
      if (result && !result.error) {
        ...
        await sock.sendMessage(chatId, {
          text: "A moment, TECH-MD is sending your results"
        }, { quoted: msg });
...
}, 
{
  ...
  execute: async (sock, msg, args) => {
    ...
    try {
      ...
      await sock.sendMessage(chatId, {
        text: "TECH-MD is sending you 5 BLACKPINK IMAGES"
      }, { quoted: msg });

      for (const imageUrl of selectedImages) {
        await sock.sendMessage(chatId, {
          image: { url: imageUrl },
          caption: "_╰►DOWNLOADED BY_ *TECH-MD*",
          contextInfo
        }, { quoted: msg });
      }
    ...
    try {
      ...
      if (data.status && data.BK9 && data.BK9.high) {
        await sock.sendMessage(chatId, {
          ...
          caption: "📸 *TECH-MD* Image Downloader (High Quality)",
          contextInfo: {
            forwardingScore: 1,
            isForwarded: true,
            forwardedNewsletterMessageInfo: {
...
*📌 App:* ${apk.name}
*📎 Type:* APK File
*⚙️ Powered by:* TECH-MD`
                }, { quoted: msg });

                await sock.sendMessage(chatId, {
                    text: `✅ Successfully fetched and sent APK for *${apk.name}*.

_Enjoy using the app. Powered by TECH-MDD_`,
                    contextInfo: {
                        forwardingScore: 1,
                        isForwarded: true,
                        forwardedNewsletterMessageInfo: {
